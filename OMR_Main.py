...
def execute():
    ...
    try:
        ...
        cv2.putText(imgRawGrade,str(int(score))+"%",(70,100)
                    ,cv2.FONT_HERSHEY_COMPLEX,3,(255,0,0),3) # ADD THE GRADE TO NEW IMAGE
        ...
        cv2.imshow('Grades',imgInvGradeDisplay)
        ...
        # print("Kedar")
        # cv2.imwrite("Scanned/"+str(count)+".jpg",imgFinal)
